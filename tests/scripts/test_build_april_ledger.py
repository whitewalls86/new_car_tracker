...
def test_ledger_joins_only_on_recomputed_content_hash_and_is_deterministic():
    ...
    legacy = [{"legacy_key": "z", "row_group": 0, "row_offset": 2, "artifact_id": 99,
               "content_bytes": content, "sha256": digest, "http_status": 200, "orphan": True},
              {"legacy_key": "a", "row_group": 0, "row_offset": 1, "artifact_id": 99,
               "content_bytes": b"wrong", "sha256": digest, "http_status": 200}]
    sidecars = [{"raw_sha256": digest, "source_key": "html/source", "pack_key": "pack.zpack", "sidecar_key": "pack.idx.parquet"}]

...
docs/plans/plan_112_refresh_policy_backtesting.md), against a job-local, throwaway Lakekeeper +
MinIO + Postgres stack. Proves the catalog itself, independent of any
client engine -- no Spark, no PyIceberg (Gate A2/A2b scope).

Known limitation (documented in docs/plans/plan_112_refresh_policy_backtesting.md): this exercises

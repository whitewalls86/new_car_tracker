...
TABLE_SPECS: list[TableSpec] = [
    ...
    TableSpec(
        ...
        not_null_columns=["vin17", "listing_id", "run_started_at", "run_ended_at"],
    ...
    TableSpec(
        ...
        not_null_columns=[
            "observation_id", "artifact_id", "listing_id", "fetched_at", "parsed_fingerprint",
        ],
        timestamp_column="fetched_at",
    ...
    TableSpec(
        ...
        not_null_columns=["listing_id", "run_started_at", "run_ended_at"],
        timestamp_column="run_ended_at",
        vin_column="vin17",
        listing_column="listing_id",
    ...
    TableSpec(
        ...
        grain_keys=["vin17"],
        not_null_columns=["vin17", "listing_id", "latest_fetched_at", "first_seen_at"],

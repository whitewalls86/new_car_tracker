...
|---:|---|---|---|---|---|---|---|---|
| 1 | [142](plans/plan_142_planned_host_maintenance.md) | Planned host maintenance and production quiescence | Stage 1 — add maintenance state and legal transitions, named active-work counts, hold/release operations, and stale-state alerts | **Y** | -- | 86 | M + first observed window | Stage 0 Phase A is deployed and soaked clean. Stage 1 may build and deploy while Plan 136's baseline runs, but its production hold/dry run and Stage 0 Phase B wait for the baseline read (~19:40 UTC 2026-08-25). Items 6-7 remain unapplied until that window; runbook §10 owns the procedure |

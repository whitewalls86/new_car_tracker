...
| 4 | [162](plans/plan_162_testing_census_and_restructure.md) | Testing census and CI restructure | Stage R — CI selection, and the instrument that has to precede it | **Y** | -- | 75 | L | Nothing blocks it. CAR-80 has no blockers for Stage T. Safe stopping point after Stage T. |

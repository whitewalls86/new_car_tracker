...
|---:|---|---|---|---|---|---|---|---|
| 1 | [161](plans/plan_161_testing_contract.md) | Testing contract | The planning session itself — answer the nine open questions, then write the contract, the `.claude/skills/` reviewer, and the test that asserts both | **Y** | -- | 87 | S | Blocks Plans 162 and 139. `ARCHITECTURE.md`'s Testing Strategy section becomes this plan's territory — rewritten as the contract or replaced by a pointer, never left as a second description |

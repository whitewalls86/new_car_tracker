...
|---:|---|---|---|---|---|---|---|---|
| 1 | [162](plans/plan_162_testing_census_and_restructure.md) | Testing census and CI restructure | Stage 4 — split the 267s `dbt build + test` job, the cheap half of the restructure | **Y** | -- | 75 | L | **Stages 0–3 complete 2026-08-31.** Stage 4 is the next slice and a safe stopping point |

...
|---:|---|---|---|---:|---|---|
| 1 | [140](plan_140_service_health_contract.md) | Service health contract | Healthchecks on the 24 services lacking them, then the container-health metric (absorbing Plan 136 Stage 0b), then CI coverage assertions | 87 | M + soak | Plan 136 Stage 0 verified in production 2026-08-18 — nothing left blocking; soak Stage 1 before alerting on it |

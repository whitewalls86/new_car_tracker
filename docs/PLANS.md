...
|---:|---|---|---|---|---|---|---|---|
| 1 | [162](plans/plan_162_testing_census_and_restructure.md) | Testing census and CI restructure | Stage S — branch coverage for the dbt models, and what leaves the SQL census | **Y** | -- | 75 | L | **Stages A–P complete** (legacy 0–10). Every waiver ledger the plan opened is still shrinking; Stage N replaced Stage L's two SQL rules with one keyed on the statement rather than its container |

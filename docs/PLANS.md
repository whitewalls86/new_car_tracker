...
|---:|---|---|---|---|---|---|---|---|
| 1 | [162](plans/plan_162_testing_census_and_restructure.md) | Testing census and CI restructure | Stage 10 — suites on real Compose services, dbt against the Plan 120 snapshot, advisory CI impact selection | **Y** | -- | 75 | L | **Stages 0–9 complete.** Every waiver ledger the plan opened is still shrinking; Stage 9 replaced Stage 7's two SQL rules with one keyed on the statement rather than its container |
...
| 3 | [172](plans/plan_172_plan_authoring_skill.md) | The plan document contract | Stage A — write `docs/PLAN_DOCUMENT.md`: the four questions a plan document owes each of its four states, the section ratchet, lettered stages with exits, and one home for evidence | **Y** | -- | 80 | M | **Blocks [Plan 138](plans/plan_138_public_surface_refresh.md) Stage 9**, which is why it sits above a higher-scored row: Stage 9's code is safe to land first, but cannot be *finished* until the published window carries the section this plan creates, or its §4 rule contradicts its own surface. Safe stopping point after any stage. Raised 2026-09-02 from a measurement — 75% of `PLANS.md` commits changed published copy over 60 days, 35 of 59 being a slice rewrite with the same four plans in the window |

...
|---:|---|---|---|---|---|---|---|---|
| 1 | [180](plans/plan_180_seam_program.md) | The seam program | Stage A — the mechanisms exist | **Y** | -- | 85 | XL | Supersedes Plan 162 Stages AL(tail)/AM/AH/AC/AD/AE/AJ; 162's native cleanup runs in parallel, not as a gate. Safe stopping point after Stage B — the ideal rules and seeded ledgers are useful without any drain. |

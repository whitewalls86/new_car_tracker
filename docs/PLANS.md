...
|---:|---|---|---|---|---|---|---|---|
| 1 | [142](plans/plan_142_planned_host_maintenance.md) **Stage 4** | Scoped operational coordination and host maintenance | Stage 4 — run one reviewed security/package maintenance window using the checked-in procedure and capture the handoff evidence | **N** | Plan 142 Stage 4 — a reviewed production maintenance window | 86 | M + first observed window | Stage 3 is complete; Stage 4 is the first scheduled execution and handoff |

...
| 3 | [162](plans/plan_162_testing_census_and_restructure.md) | Testing census and CI restructure | Stub until Plan 161 lands — then the census, the 267s dbt-job split, dbt against the Plan 120 snapshot, and the suites on real Compose services | **N** | Plan 161 | 75 | XL | **XL is a placeholder** Plan 161 replaces with a real estimate; do not start the census before the contract exists |

...
|---:|---|---|---|---|---|---|---|---|
| 1 | [162](plans/plan_162_testing_census_and_restructure.md) | Testing census and CI restructure | Stage S — branch coverage for the dbt models, and what leaves the SQL census | **Y** | -- | 75 | L | Nothing blocks it. CAR-79 has no blockers for Stage S. Safe stopping point after Stage S. |

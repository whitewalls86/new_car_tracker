...
|---:|---|---|---|---|---|---|---|---|
| 1 | [164](plans/plan_164_cycle_close_ritual.md) | Cycle-close ritual | Stage 4 — mark the seed when it is made, and count it by the mark; lands before Cycle 4's seed on 2026-09-14 | **Y** | -- | 70 | S | Nothing blocks it. Must land before `fill-cycle` seeds Cycle 4 on 2026-09-14; if Plan 149 removes Linear on 2026-09-15, Stage 4 goes with Stages 1 and 2. |

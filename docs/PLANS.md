...
|---:|---|---|---|---|---|---|---|---|
| 1 | [162](plans/plan_162_testing_census_and_restructure.md) | Testing census and CI restructure | Stage 5 — the mechanical sweeps: 34 mock conversions, 16 layer renames, and the one harness-decides-the-outcome test | **Y** | -- | 75 | L | **Stages 0–4 complete; Stage 4 CAR-48 2026-09-01.** Stage 5 is the next slice and closes 50 of the 116 waivers |

...
|---:|---|---|---|---|---|---|---|---|
| 1 | [162](plans/plan_162_testing_census_and_restructure.md) | Testing census and CI restructure | Stage 3 — the two health-sensor censuses read one declared source instead of two hardcoded counts | **Y** | -- | 75 | L | Stage 3 is the next slice and a safe stopping point |

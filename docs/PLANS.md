...
| 2 | [162](plans/plan_162_testing_census_and_restructure.md) | Testing census and CI restructure | Stage AK — drain the guessed-bounds floor ledger (24 entries), then Stage R | **Y** | -- | 75 | L | Nothing blocks it. CAR-80 has no blockers for Stage T. Safe stopping point after Stage T. |

...
|---:|---|---|---|---|---|---|---|---|
| 1 | [162](plans/plan_162_testing_census_and_restructure.md) | Testing census and CI restructure | Stage Y — a route declares its statuses, observes its own effects, and exercises both | **Y** | -- | 75 | L | Nothing blocks it. CAR-80 has no blockers for Stage T. Safe stopping point after Stage T. |
...
[**completed_plans.md**](planning/completed_plans.md) — 123 rows, newest first, one row

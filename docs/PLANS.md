...
|---:|---|---|---|---|---|---|---|---|
| 1 | [162](plans/plan_162_testing_census_and_restructure.md) | Testing census and CI restructure | Stage 10b — CI's services are production's, in definition and in contents | **Y** | -- | 75 | L | **Stages 0–9 complete.** Every waiver ledger the plan opened is still shrinking; Stage 9 replaced Stage 7's two SQL rules with one keyed on the statement rather than its container |

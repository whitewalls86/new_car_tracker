...
|---:|---|---|---|---|---|---|---|---|
| 1 | [162](plans/plan_162_testing_census_and_restructure.md) | Testing census and CI restructure | Stage 8 — the services below the floor: dashboard's 7 modules with 0 test files, and scraper's single integration file (G7, G8) | **Y** | -- | 75 | L | **Stages 0–6b complete.** `ROUTE_WAIVERS` and `ENCODING_WAIVERS` are empty; 56 waivers remain, all Layer 2 — which is exactly Stage 7's target |

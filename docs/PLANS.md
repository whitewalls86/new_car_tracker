...
| 2 | [134](plans/plan_134_archiver_endpoint_failure_contract.md) | Archiver endpoint failure contract | Stage 0 — measure the historical failure rate from the 90 days of archiver ERROR records Loki already holds, then Stage 1's warning-only predicates and the one-week window | **Y** | -- | 88 | S | Plan 141 completed 2026-08-26; the one-week observation begins when Plan 134's warning-only predicates deploy, then enforcement follows if the evidence is clean |

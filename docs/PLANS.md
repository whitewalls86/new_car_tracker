...
| 2 | [142](plans/plan_142_planned_host_maintenance.md) | Scoped operational coordination and host maintenance | Stage 2 running-set manifest capture and read-only host preflight | **Y** | -- | 86 | M + first observed window | Stage 1 deployed and proven end to end 2026-08-25; Stage 0 Phase B ran and closed clean the same evening. Production holds wait until Plan 136 Stage 3b's 48-hour soak finishes |

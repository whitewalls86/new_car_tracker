...
|---|---|---|---|
| Time to choose next work | **Better, with friction that has a named cause.** Maintainer, 2026-08-31: knowing what to do next was no longer the problem; the friction was "the gap between seeded work and output". That gap is the row below, measured — 17 points seeded against 48 delivered — so this is the same finding felt rather than a second one | **Better.** Maintainer, 2026-09-12: picking felt great. Cycle 1's named friction, the gap between seeded work and output, narrowed — 18 seeded points plus 4 rolled in, against 76 delivered | — |
| Issues added after cycle start | **17 of 25 issues (68%); 31 of 48 points (65%).** Seeded 8 issues / 17 points. This is the measurement that turned the eight-issue cap into a points budget | **34 of 45 issues (76%); 58 of 80 points (73%).** Seeded 9 issues / 18 points — CAR-33…CAR-41, one `fill-cycle` batch at 2026-08-31 15:09–15:11Z — plus 2 rolled in from Cycle 1 (CAR-17, CAR-31, 4 points). The seed was created ten hours *after* `startsAt` (05:00Z, midnight Central), so `createdAt < startsAt` reads it as zero seeded; the batch is identified by its timestamps instead. Four more were added and closed without completing — CAR-64, CAR-75, CAR-76 canceled, CAR-90 a duplicate of CAR-79, 6 points — and sit outside these counts, as Linear's history excludes them | — |
| Issue rollover | **2 of 25 issues (8%), 4 of 48 points.** CAR-17 (`Ready`) and CAR-31 (`Soaking`), both moved to Cycle 2 by Linear automatically at the close — no manual action, and none required. Neither is an oversized slice: CAR-31 is a seven-day observation window and CAR-17 waits on four Plan 142 Stage 2/3 defects. Rollover here measures gating, not slicing | **2 of 45 issues (4%), 4 of 80 points.** CAR-31 (`Soaking`) and CAR-79 (`Ready`), moved to Cycle 3 by Linear at the close with no manual action. CAR-31 rolls for the second time: Plan 134 Stage B's seven-day window closed 2026-09-07 02:04Z, three hours before the cycle, and the issue closed at 18:10Z once its evidence was written — gating again, not slicing. Completed: 43 issues / 76 points in 7 days | — |
| State corrections | **Partial — three known, no exhaustive count.** CAR-21 was flipped to `Soaking` twice by the merge automation mid-build and hand-corrected back twice; CAR-22 sat in `Ready` through its entire Stage 6 build and was moved by hand on 2026-08-30; and six of six transitions were manual on 2026-08-25, before the automation was understood. A complete figure needs a per-issue history read, which this one did not do — recorded as partial rather than presented as a total | **Partial — one known.** CAR-114 was filed into Cycle 2 on 2026-09-09, two days after it closed; created, started and finished that day, it is Cycle 3's work. The history arrays froze at the close and exclude it, but any membership read of Cycle 2 or Cycle 3 is off by one. No per-issue state history was read for the other 44, which a complete figure needs | — |
| Duplicate edits | **Two, both on canceled issues.** CAR-28 held ~4,000 words duplicating Plan 145's ordering-trial evidence, was canceled 2026-08-27 and was still being edited 2026-08-30. CAR-27 was created and canceled into [Plan 156](plan_156_block_page_detection.md). Both are the shape Stage 3's *Remove* criterion names | **Partial — one candidate.** CAR-90 carried Plan 162 §Stage S's measured counts (0 of 187 columns typed, 17 of 23 models complete) and was closed as a duplicate of CAR-79 on 2026-09-06. It was never edited after creation, so the fact was written twice but not maintained twice — smaller than CAR-28's shape. No per-issue edit history was read | — |
| Recap effort | **Unchanged.** Maintainer, 2026-08-31: the 2026-08-30 recap was written from git and read Linear not at all, which is the design working — Linear supplies execution facts and does not replace the git-and-plan read. Follow-up identified rather than acted on: there is room to fold Linear history into the recap skill, to be tested against the next recap | **Unchanged.** Maintainer, 2026-09-12: the 2026-09-06 recap was written from git and did not read Linear — `plan-week` has no Linear step, and CAR identifiers appear in it only through commit subjects. Cycle 1's follow-up, folding Linear history into the recap skill, was not acted on, so this recap did not test it | — |

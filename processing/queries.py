...
INSERT_BLOCKED_COOLDOWN_CLEARED_EVENT = _load("insert_blocked_cooldown_cleared_event")
...
INSERT_BACKFILL_PRICE_OBSERVATION_EVENT = _load("insert_backfill_price_observation_event")

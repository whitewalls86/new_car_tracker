...
--
-- last_detail_scraped_at: set by detail writes only (pass NULL from SRP/carousel).
-- COALESCE preserves a previous value; a non-NULL incoming value always wins.
